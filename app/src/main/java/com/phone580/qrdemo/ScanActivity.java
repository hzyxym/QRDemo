...
import com.phone580.qrdemo.camera.CameraPreview;
import com.phone580.qrdemo.camera.ScanCallback;
        ...
        AndPermission.with(this)
                ...
                .callback(new PermissionListener() {
                    ...
                    public void onFailed(int requestCode, @NonNull List<String> deniedPermissions) {
                        AndPermission.defaultSettingDialog(ScanActivity.this).show();
                    }
                })
                .start();
    }
